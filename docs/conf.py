...
htmlhelp_basename = 'AndroidAPS documentation'
...
man_pages = [
    (master_doc, 'androidaps_doc', 'AndroidAPS documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AndroidAPS_Doc', 'AndroidAPS_Doc Documentation',
     author, 'AndroidAPS_Doc', 'One line description of project.',
     'Miscellaneous'),
]
